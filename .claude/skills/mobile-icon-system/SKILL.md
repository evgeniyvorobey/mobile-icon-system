...
description: Self-contained workflow for mobile app icon systems — full static icon sets, style packs/plugins, A/B/C style review, platform exports, and Animated/Lottie validation. WCAG 2.2 accessible. Integrates with Figma / Pencil MCP when available. Use directly in Claude with /mobile-icon-system.
